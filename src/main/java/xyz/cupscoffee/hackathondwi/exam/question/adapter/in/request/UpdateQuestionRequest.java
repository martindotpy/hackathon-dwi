...
@NoArgsConstructor
@AllArgsConstructor
public final class UpdateQuestionRequest implements UpdateQuestionPayload {
    @NotNull(message = "question.update.request.id.not-null")
    @Positive(message = "question.update.request.id.positive")
    private Long id;
