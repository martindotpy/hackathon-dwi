package xyz.cupscoffee.hackathondwi.user.adapter.persistence;
...
import xyz.cupscoffee.hackathondwi.user.adapter.persistence.repository.SpringUserRepository;
